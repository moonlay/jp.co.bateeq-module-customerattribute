...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Moonlay_CustomerAttribute::save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Moonlay_CustomerAttribute::customer_attributes')
    ...
    protected function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('Customer'), __('Customer'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Customer Attributes'))
            ->setActiveMenu('Moonlay_CustomerAttribute::customer_attributes');
        if (!empty($title)) {
